...
/// Technical, engine-facing settings -- everything that used to be the entire SettingsView
/// before it grew a Personalization and Socials tab alongside it.
struct SettingsConfigView: View {
    ...
    var body: some View {
        Form {
            Section {
                Text("Changes below save immediately but only take effect the next time you start a game -- the engine reads them once, at the first launch each session.")
                    .font(.caption)
            ...
            Section("Debug: Export Game Executable") {
